...
let sourceArray = complex.sourceArray;
let titleArray = complex.titleArray;
let compareArray = [];
let countSources = [];
...
const main = () => {
    ...
    let simpleCompare = schedule.scheduleJob('54 * * * *', function(){
        let ref = db.ref("/newsdata/zxl36W7TxudNhEsduy6a/");
        let splitArray = splitFunction(titleArray);
